       ...
       return (
         <div className="relative h-[70vh] bg-cover bg-center" style={{ backgroundImage: "url('/banner.jpg')" }}>
           ...
           <div className="absolute bottom-20 left-6 md:left-12 text-white space-y-4">
             ...
             <p className="max-w-md text-sm md:text-base">Après plus de 30 ans de service en tant que l'un des meilleurs aviateurs de la Marine, Pete "Maverick" Mitchell est à sa place, repoussant les limites en tant que pilote d'essai courageux et esquivant l'avancement de grade qui le mettrait à la terre.</p>
